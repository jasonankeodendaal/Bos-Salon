...
const ClientPortal: React.FC<ClientPortalProps> = ({ 
  ...
  const handleSignUp = async (e: React.FormEvent) => {
      ...
      try {
          ...
          // Instant Login Logic - Optimistic Update
          const tempUser = { 
              ...newClient, 
              id: 'temp-' + Date.now(), 
              loyaltyProgress: {}, 
  ...
  if (!isLoggedIn) {
    return (
      <div 
        className="min-h-screen flex flex-col justify-center items-center text-brand-light p-4 font-sans relative bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        <div className="w-full max-w-sm mx-auto z-10 relative">
          ...
          <div className="bg-white/80 backdrop-blur-lg border border-gray-200 rounded-2xl shadow-2xl p-8 transition-all duration-300">
            ...
            <p className="text-center text-gray-500 text-sm mb-6">{isSignUpMode ? 'Create your profile to start.' : 'Access your rewards and history.'}</p>
                    ...
                    {isSignUpMode ? (
                        ...
                        <form onSubmit={handleSignUp} className="space-y-4">
                            <div>
                                ...
                                <input 
                                    ...
                                    className="w-full bg-white border border-gray-300 rounded-full p-3 text-black placeholder-gray-400 outline-none focus:ring-2 focus:ring-brand-green shadow-sm transition-all"
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-500 mb-1 ml-1">Phone (Optional)</label>
                                <input 
                                    type="tel" 
                                    value={signUpPhone}
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 mb-1 ml-1">Create PIN</label>
                                    <input 
                                        type="password" 
                                        required 
                                        value={signUpPin}
                                        onChange={e => setSignUpPin(e.target.value)}
                                        className="w-full bg-white border border-gray-300 rounded-full p-3 text-black placeholder-gray-400 outline-none focus:ring-2 focus:ring-brand-green shadow-sm text-center tracking-widest"
                                        placeholder="****"
                                        maxLength={6}
                                    />
                                </div>
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 mb-1 ml-1">Confirm PIN</label>
                                    <input 
                                        type="password" 
                                        required 
                            ...
                            <button 
                                type="submit"
                                className="w-full bg-brand-green text-white py-3 rounded-full font-bold text-sm hover:bg-opacity-90 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all mt-4"
                            >
                                Sign Up & Login
                            </button>
                            <p className="text-center text-xs text-gray-500 mt-2">
                                Already have an account? <button type="button" onClick={() => setIsSignUpMode(false)} className="text-brand-green font-bold hover:underline">Log In</button>
                            </p>
                        </form>
                    ) : (
                        /* LOGIN FORM */
                        <>
                            <form onSubmit={handleManualLogin} className="space-y-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-white border border-gray-300 rounded-full p-3 text-black placeholder-gray-400 outline-none focus:ring-2 focus:ring-brand-gold focus:border-brand-gold shadow-sm transition-all"
                                        placeholder="name@example.com"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full bg-white border border-gray-300 rounded-full p-3 text-black placeholder-gray-400 outline-none focus:ring-2 focus:ring-brand-gold focus:border-brand-gold shadow-sm tracking-widest transition-all"
                                        placeholder="****"
                                    />
                                </div>
                                <button 
                                    type="submit"
                                    className="w-full bg-brand-gold text-white py-3 rounded-full font-bold text-sm hover:bg-opacity-90 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all mt-2"
                                >
                                    Log In
                                </button>
                            </form>
                            ...
                            <div className="relative flex items-center py-2">
                                ...
                                <span className="flex-shrink-0 mx-4 text-xs font-bold text-gray-400 uppercase">OR</span>
                                <div className="flex-grow border-t border-gray-300"></div>
                            </div>
                            ...
                            <div>
                                <button 
                                    ...
                                    className="w-full bg-white border border-gray-300 text-gray-700 py-3 rounded-full font-bold text-sm hover:bg-gray-50 shadow-sm flex items-center justify-center gap-3 transition-colors hover:border-gray-400"
                                >
                            ...
                            <div className="text-center pt-2">
                                <p className="text-xs text-gray-400 mb-2">New to the portal?</p>
                                <button 
                                    onClick={() => setIsSignUpMode(true)}
                                    className="text-brand-green font-bold text-sm hover:underline uppercase tracking-wide"
                                >
                                    Create Account
                                </button>
                            </div>
